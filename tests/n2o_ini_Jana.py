...
target = '/net/kryo/work/jahaerri/roms/inputs/humpac15_Ncycle/grd/humpac15_grd.nc'
out = '/net/kryo/work/jahaerri/roms/inputs/humpac15_Ncycle/humpac_n2o_ini.nc'
sources = [
    {
        'variables': [
...
roms_clim = PreProcessor(target, out, sources, theta_s = 10.0, theta_b = 4.0, layers = 64, hc = 250.0, tcline = 250.0, sigma_type = 3, verbose=True)
